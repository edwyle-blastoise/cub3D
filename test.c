...
//gcc -g -Wall -Wextra -Werror -lmlx -framework OpenGL -framework AppKit gnl/*c libmlx.a libft.a cub3d.c parser.c player.c create_map.c raycasting.c check_map.c textures.c draw.c sprites.c screenshot_bmp.c check_errors.c && ./a.out map.cub 
